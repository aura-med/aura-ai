...
test('clinical acknowledgment is limited to clinical staff and owners', () => {
  ...
  assert.equal(canAcknowledgeRecommendation('masseur', 'clinical'), true)
...
test('coach acknowledgment is limited to squad staff and owners', () => {
  ...
  assert.equal(canAcknowledgeRecommendation('nutritionist', 'coach'), true)
  assert.equal(canAcknowledgeRecommendation('director', 'coach'), true)
  assert.equal(canAcknowledgeRecommendation('scout', 'coach'), true)
  assert.equal(canAcknowledgeRecommendation('team_manager', 'coach'), true)
