...
export interface OsiicsEntry {
  ...
  protocolKey?: string  // key in rehab_protocols for auto-suggestion
}

export const OSIICS_FOOTBALL: OsiicsEntry[] = [
  // ── Hamstrings ──────────────────────────────────────────────────────────────
  { code: 'MT2IM',  description: 'Lesão muscular isquiotibiais grau I',       bodyPart: 'Coxa posterior', category: 'injury', protocolKey: 'hamstring_grade_i'   },
  { code: 'MT2II',  description: 'Lesão muscular isquiotibiais grau II',      bodyPart: 'Coxa posterior', category: 'injury', protocolKey: 'hamstring_grade_ii'  },
  { code: 'MT2III', description: 'Lesão muscular isquiotibiais grau III (rotura)', bodyPart: 'Coxa posterior', category: 'injury', protocolKey: 'hamstring_grade_iii' },
  ...
  // ── Adductors ───────────────────────────────────────────────────────────────
  { code: 'MG1IM',  description: 'Lesão muscular adutores grau I',     bodyPart: 'Virilha', category: 'injury', protocolKey: 'adductor_grade_i_ii' },
  { code: 'MG1II',  description: 'Lesão muscular adutores grau II',    bodyPart: 'Virilha', category: 'injury', protocolKey: 'adductor_grade_i_ii' },
  { code: 'MG1III', description: 'Rotura completa dos adutores',       bodyPart: 'Virilha', category: 'injury' },
  // ── Calf ────────────────────────────────────────────────────────────────────
  { code: 'ML1IM',  description: 'Lesão muscular gastrocnémio grau I', bodyPart: 'Gémeo/Sural', category: 'injury', protocolKey: 'calf_strain_grade_i_ii' },
  { code: 'ML1II',  description: 'Lesão muscular gastrocnémio grau II', bodyPart: 'Gémeo/Sural', category: 'injury', protocolKey: 'calf_strain_grade_i_ii' },
  { code: 'ML1III', description: 'Rotura do gastrocnémio',             bodyPart: 'Gémeo/Sural', category: 'injury' },
  { code: 'ML2IM',  description: 'Lesão do solear grau I-II',          bodyPart: 'Sural', category: 'injury', protocolKey: 'calf_strain_grade_i_ii' },
  // ── Ankle ───────────────────────────────────────────────────────────────────
  { code: 'JA1LI',   description: 'Entorse lateral do tornozelo grau I',          bodyPart: 'Tornozelo', category: 'injury', protocolKey: 'ankle_sprain_grade_i'   },
  { code: 'JA1LII',  description: 'Entorse lateral do tornozelo grau II',         bodyPart: 'Tornozelo', category: 'injury', protocolKey: 'ankle_sprain_grade_ii'  },
  { code: 'JA1LIII', description: 'Rotura ligamentar lateral do tornozelo',       bodyPart: 'Tornozelo', category: 'injury', protocolKey: 'ankle_sprain_grade_iii' },
  ...
  { code: 'JA4',     description: 'Tendinopatia de Aquiles',                      bodyPart: 'Tornozelo/Calcâneo', category: 'injury', protocolKey: 'achilles_tendinopathy' },
  { code: 'JA5',     description: 'Rotura do tendão de Aquiles',                  bodyPart: 'Tornozelo/Calcâneo', category: 'injury' },
  // ── Knee ────────────────────────────────────────────────────────────────────
  { code: 'JK1ACL', description: 'Lesão do ligamento cruzado anterior (LCA)',   bodyPart: 'Joelho', category: 'injury', protocolKey: 'acl_prehab' },
  { code: 'JK1PCL', description: 'Lesão do ligamento cruzado posterior (LCP)',  bodyPart: 'Joelho', category: 'injury' },
  { code: 'JK1MCL', description: 'Lesão do ligamento colateral medial',         bodyPart: 'Joelho', category: 'injury', protocolKey: 'mcl_grade_i_ii' },
  { code: 'JK1LCL', description: 'Lesão do ligamento colateral lateral',        bodyPart: 'Joelho', category: 'injury' },
  { code: 'JK2MM',  description: 'Lesão do menisco medial',                     bodyPart: 'Joelho', category: 'injury', protocolKey: 'meniscus_conservative' },
  { code: 'JK2LM',  description: 'Lesão do menisco lateral',                    bodyPart: 'Joelho', category: 'injury', protocolKey: 'meniscus_conservative' },
  ...
  { code: 'JK5',    description: 'Tendinopatia patelar (joelho do saltador)',    bodyPart: 'Joelho/Patelar', category: 'injury', protocolKey: 'patellar_tendinopathy' },
  ...
  { code: 'GG1', description: 'Pubalgia / groin pain crónico',                   bodyPart: 'Virilha/Púbis', category: 'injury', protocolKey: 'groin_chronic' },
